namespace GmailServer
{
    public static class PermissionNames
    {
        ...
        public const string AppleId_DeleteAll = AppleId + ".DeleteAll";
        public const string AppleId_DeleteFilter = AppleId + ".DeleteFilter";
        ...
        public const string DownloadedApp_Create = DownloadedApp + ".Create";
        public const string DownloadedApp_Delete = DownloadedApp + ".Delete";
