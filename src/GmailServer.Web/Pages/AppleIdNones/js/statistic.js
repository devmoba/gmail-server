$(function () {
    ...
    gmailServer.controllers.appleIdNone.getUsernameSelection().done((usernames) => {
        var searchs = [
            { searchDisabled: true },
        ...
        devmoba.datatables.enableIndividualColumnSearch("#appleIdNoneStatisticTable", searchs);
        ...
        var datatableConfig = abp.libs.datatables.normalizeConfiguration({
            ...
            ajax: abp.libs.datatables.createAjax(gmailServer.controllers.appleIdNone.getStatistic, () => {
        ...
        $('#appleIdNoneStatisticTable').DataTable(devmoba.datatables.fixDomConfiguration(datatableConfig));
    });
});