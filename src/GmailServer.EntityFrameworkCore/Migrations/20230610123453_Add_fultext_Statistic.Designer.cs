...
namespace GmailServer.Migrations
{
    ...
    [Migration("20230610123453_Add_fultext_Statistic")]
    partial class Add_fultext_Statistic
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GmailServer.Entities.AppleId", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AppAppleIds");
                });

            modelBuilder.Entity("GmailServer.Entities.AppleIdNone", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("AddPaymentCompleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.Property<int>("RemovePaymentStatus")
                        .HasColumnType("int");

                    b.Property<DateTime>("RemoveTakenTime")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("RemoveUpdateTime")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("SqlServer:Include", new[] { "Username", "Created", "Status", "AddPaymentCompleted", "RemovePaymentStatus", "RemoveTakenTime", "RemoveUpdateTime" });

                    b.ToTable("AppAppleIdNones");
                });

            modelBuilder.Entity("GmailServer.Entities.AppleIdRaw", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("SqlServer:Include", new[] { "Created" });

                    b.HasIndex("Username")
                        .IsUnique()
                        .HasFilter("[Username] IS NOT NULL");

                    b.ToTable("AppAppleIdRaws");
                });

            modelBuilder.Entity("GmailServer.Entities.AppleOrder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTime>("AddPaymentCompletedTime")
                        .HasColumnType("datetime2");

                    b.Property<int>("AddPaymentStatus")
                        .HasColumnType("int");

                    b.Property<DateTime>("AddPaymentTakenTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("LinkCompletedTime")
                        .HasColumnType("datetime2");

                    b.Property<int>("LinkStatus")
                        .HasColumnType("int");

                    b.Property<DateTime>("LinkTakenTime")
                        .HasColumnType("datetime2");

                    b.Property<string>("MomoAccount")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("SqlServer:Include", new[] { "OrderID", "URLPayment", "LinkStatus", "AddPaymentStatus", "LinkTakenTime", "LinkCompletedTime", "AddPaymentTakenTime", "AddPaymentCompletedTime" });

                    b.ToTable("AppAppleOrders");
                });

            modelBuilder.Entity("GmailServer.Entities.Checker", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("AppCheckers");
                });

            modelBuilder.Entity("GmailServer.Entities.DownloadedApp", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("GmailServer.Entities.FakeSetting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("AppFakeSettings");
                });

            modelBuilder.Entity("GmailServer.Entities.Gmail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("GmailTypeId");

                    b.HasIndex("Id")
                        .HasAnnotation("SqlServer:Include", new[] { "Status", "Created", "Updated", "LastCheck", "RecoveryEmail", "Country" });

                    b.ToTable("AppGmails");
                });

            modelBuilder.Entity("GmailServer.Entities.GmailPremium", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("AppGmailPremiums");
                });

            modelBuilder.Entity("GmailServer.Entities.GmailResource", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTime>("UpdatedPremium")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("AppGmailResources");
                });

            modelBuilder.Entity("GmailServer.Entities.GmailType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("AppGmailTypes");
                });

            modelBuilder.Entity("GmailServer.Entities.MomoAccount", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("AuthenticateToken")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("CreatedTime")
                        .HasColumnType("datetime2");

                    b.Property<int>("CurrentLinkCount")
                        .HasColumnType("int");

                    b.Property<string>("CustmArg1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustmArg2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustmArg3")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SessionKey2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SetupKey")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Status")
                        .HasColumnType("int");

                    b.Property<int>("TotalLinkCount")
                        .HasColumnType("int");

                    b.Property<string>("UDid1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UDid2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UploadGroup")
                        .IsRequired()
                        .HasMaxLength(1024)
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("SqlServer:Include", new[] { "UploadGroup", "CreatedTime", "Email", "Status", "CurrentLinkCount", "TotalLinkCount", "LastUpdateTime", "LastTakenTime" });

                    b.HasIndex("Username")
                        .IsUnique();

                    b.ToTable("AppMomoAccounts");
                });

            modelBuilder.Entity("GmailServer.Entities.OwnerConfig", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("AppOwnerConfigs");
                });

            modelBuilder.Entity("GmailServer.Entities.RecoveryEmail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("AppRecoveryEmails");
                });

            modelBuilder.Entity("GmailServer.Entities.Statistic", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("SqlServer:Include", new[] { "Date", "EntityName", "Type" });

                    b.ToTable("AppStatistics");
                });

            modelBuilder.Entity("GmailServer.Entities.TaskCheck", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("SqlServer:Include", new[] { "Username", "EmailChecks", "Status", "TypeCheck", "CheckerId", "Created" });

                    b.ToTable("AppTaskChecks");
                });
            ...
            modelBuilder.Entity("GmailServer.Entities.Gmail", b =>
                {
                    b.HasOne("GmailServer.Entities.GmailType", "GmailType")
                        .WithMany("Gmails")
                        .HasForeignKey("GmailTypeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("GmailType");
                });

            modelBuilder.Entity("GmailServer.Entities.TaskCheck", b =>
                {
                    b.HasOne("GmailServer.Entities.Checker", "Checker")
                        .WithMany("TaskChecks")
            ...
            modelBuilder.Entity("GmailServer.Entities.AppleId", b =>
                {
                    b.Navigation("DownloadedApps");
                });

            modelBuilder.Entity("GmailServer.Entities.Checker", b =>
                {
                    b.Navigation("TaskChecks");
                });
