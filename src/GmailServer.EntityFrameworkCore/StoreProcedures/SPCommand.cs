...
namespace GmailServer.StoreProcedures
{
    public static class SPCommand
    {
        ...
        public static DbCommand WithSqlParam(this DbCommand cmd, string paramName, object paramValue, ParameterDirection direction)
        {
